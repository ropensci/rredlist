...
#### 5\. Taxonomic lookup with query (~11 pages of results)
...
#### 6\. Taxonomic lookup with query (~37 pages of results)
...
#### 7\. Taxonomic lookup with query (~922 pages of results)
...
Again, even with 37 pages of data to parse, the download takes the vast majority of the time. The highest-level parsing has increased to about 1% of the time it takes to download the data, but this remains less than a second compared to the ~35 second download.
